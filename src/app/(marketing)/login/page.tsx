      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-[#1a1a2e] border border-[#2a2a3e] rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 bg-white hover:bg-gray-50 text-gray-800 font-semibold rounded-xl transition-all flex items-center justify-center gap-3 mb-6 disabled:opacity-50"
          >
